<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="approvedRequests.aspx.cs" Inherits="KFMS_PROJECT.src.approvedRequests" %>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-light text-center">
                        <h3>Approved Enrollment Requests - طلبات الالتحاق  المقبولة   </h3>
                    </div>
                    <div class="card-body">
