...
Sys.WebForms.Menu = function(options) {
    ...
    Sys.WebForms.Menu._domHelper.appendclass(this.element, this.displayMode);
...
Sys.WebForms.MenuItem = function(parentMenu, listElement, topLevelMenuItem) {
    ...
    if (this._anchor) {
        ...
        if (subMenu) {
            ...
            if (!this.childMenu.isStatic()) {
                Sys.WebForms.Menu._domHelper.appendclass(this.element, 'has-popup');
    ...
    Sys.WebForms.Menu._domHelper.appendclass(listElement, parentMenu.displayMode);
    if (this._anchor) {
        Sys.WebForms.Menu._domHelper.appendclass(this._anchor, parentMenu.displayMode);
    }
...
Sys.WebForms.MenuItem.prototype = {
    ...
    highlight: function(highlighting) {
        if (highlighting) {
            ...
            Sys.WebForms.Menu._domHelper.appendclass(this._anchor, 'highlighted');
        }
        else {
            Sys.WebForms.Menu._domHelper.removeclass(this._anchor, 'highlighted');
            this.setTabIndex(-1);
        }
    },
...
Sys.WebForms.Menu._domHelper = {
    ...
    appendclass: function(element, value) {
